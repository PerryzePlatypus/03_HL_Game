...
def instructions():
    ...
    print("""
    \n\033[95m*** ↑↑↑ Higher or Lower Game Instructions ↓↓↓ ***\033[0m
...
# Ask the user to enter an integer more than 0
    if low is None and high is None:
        error = "Please enter an integer more than 0"

# ask the user to enter an integer above the low
    elif low is not None and high is None:
        error = (f"Please enter an integer that is"
                 f"more than / equal to {low}")

# ask the user to enter an integer between the low and high
    else:
...
print()
print(" \033[1m[↑↑↑↑] Higher or Lower Game [↓↓↓↓]\033[0m ")
print()

# ask the user if they want to input how many rounds they want or use the infinite mode
num_rounds = int_check( "How Many \033[1mRounds?\033[0m or <enter for \033[1mINFINITE\033[0m> : ", low=1, exit_code="")

if num_rounds == "":
    mode = "infinite"
    num_rounds = 5

# ask the user if they want to use the default parameters ( the secret number between 0-10 )
default_params = yes_no("\033[1mDo you want to use the default game parameters? ( numbers inbetween 0 - 10 )\033[0m")
...
while rounds_played < num_rounds:
    ...
    while guess != secret and guesses_used < guesses_allowed:
        ...
        if guess in already_guessed:
            ...
            print(feedback)
            # warns the user that their on the last guess
